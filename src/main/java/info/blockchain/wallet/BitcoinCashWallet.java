...
public class BitcoinCashWallet extends DeterministicWallet{
    ...
    private static final String COIN_PATH = "M/44H/145H";
     ...
     * @throws IOException
     */
    public BitcoinCashWallet(AbstractBitcoinNetParams params)
     ...
     * @throws IOException
     */
    public BitcoinCashWallet(String entropyHex, String passphrase,
        AbstractBitcoinNetParams params)
     ...
     * @throws IOException
     */
    public BitcoinCashWallet(List<String> mnemonic, String passphrase, AbstractBitcoinNetParams params)
        throws MnemonicException, IOException {
