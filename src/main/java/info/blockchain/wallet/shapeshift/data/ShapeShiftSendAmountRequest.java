...
public class ShapeShiftSendAmountRequest {
    ...
    public static ShapeShiftSendAmountRequest fromJson(String json) throws IOException {
        return new ObjectMapper().readValue(json, ShapeShiftSendAmountRequest.class);
    }
