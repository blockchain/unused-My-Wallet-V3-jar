...
public class ShapeShiftSendAmountResponse {
    ...
    public static ShapeShiftSendAmountResponse fromJson(String json) throws IOException {
        return new ObjectMapper().readValue(json, ShapeShiftSendAmountResponse.class);
    }
