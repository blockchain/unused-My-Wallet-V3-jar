                        ...
                        if (_input.has("prev_out")) {
                            ...
                            if (prev_out != null) {
                                ...
                                if (prev_out.has("xpub")) {
                                    ...
                                    if (PayloadManager.getInstance().getPayload().getLegacyAddressStringList().contains(input.addr)) {
                                        our_xput = true;
                                    }
                                }
                    ...
                    for (int j = 0; j < _outputs.length(); j++) {
                        ...
                        if (_output != null) {
                            ...
                            if (_output.has("xpub")) {
                                ...
                                // TODO: 17/02/2017
                                if (PayloadManager.getInstance().getPayload().getLegacyAddressStringList().contains(output.addr)) {
                                    our_xput = true;
                                }
                            }
