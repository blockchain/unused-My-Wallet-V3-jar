...
public class SharedMetadata {
     ...
     * Do auth challenge
     */
    private void authorize() throws SharedMetadataException, IOException {
    ...
    public Invitation acceptInvitation(String inviteId) throws IOException, SharedMetadataException {
