...
public class ToolsTest {
    ...
    public void applyBip69() throws Exception {
        ...
        Transaction correctTransaction = new Transaction(BitcoinMainNetParams.get(), payload);
    ...
    private static Transaction shuffleTransaction (Transaction transaction) {
        Transaction shuffledTransaction = new Transaction(BitcoinMainNetParams.get());
