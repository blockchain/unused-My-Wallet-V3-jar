...
public class WalletBaseBodyTest extends MockedResponseTest {
    ...
    public void fromJson_v3_1() throws Exception {
        ...
        WalletBaseBody walletBaseBody = WalletBaseBody.fromJson(walletBase);
    ...
    public void fromJson_v1_2() throws Exception {
        URI uri = PayloadTest.class.getClassLoader().getResource("wallet_v1_2.txt").toURI();
        String walletBase = new String(Files.readAllBytes(Paths.get(uri)), Charset.forName("utf-8"));
    ...
    public void fromJson_v1_3() throws Exception {
        URI uri = PayloadTest.class.getClassLoader().getResource("wallet_v1_3.txt").toURI();
        String walletBase = new String(Files.readAllBytes(Paths.get(uri)), Charset.forName("utf-8"));
    ...
    public void encryptAndWrapPayload() throws Exception {
        ...
        WalletBody walletBody = encryptedwalletWrapper.decryptPayload("MyTestWallet");
