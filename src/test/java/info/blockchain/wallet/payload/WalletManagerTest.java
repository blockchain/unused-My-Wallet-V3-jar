...
public class WalletManagerTest extends MockedResponseTest {
    ...
    public void create() throws Exception {
        ...
        WalletBody walletBody = WalletManager.getInstance()
            .getWalletBody();
    ...
    public void recoverFromMnemonic() throws Exception {
        ...
        WalletManager.getInstance().recoverFromMnemonic(mnemonic, "My HDWallet", "name@email.com");
    ...
    public void initializeAndDecrypt_invalidGuid() throws Exception {
        ...
        URI uri = WalletManagerTest.class.getClassLoader().getResource("invalid_guid.txt").toURI();
        String walletBase = new String(Files.readAllBytes(Paths.get(uri)),
            Charset.forName("utf-8"));
