...
public class WalletApiTest extends MockedResponseTest {
    ...
    public void getEncryptedPayload() throws IOException, URISyntaxException {
        ...
        testObserver.assertComplete();
        testObserver.assertNoErrors();
        WalletBase walletBaseBody = WalletBase.fromJson(testObserver.values().get(0).string());
    ...
    public void getEncryptedPayload_invalid_guid() throws IOException, URISyntaxException {
        ...
        assertEquals(500, ((HttpException) testObserver.errors().get(0)).code());
        assertTrue(testObserver.errors().get(0).getMessage().contains("initial_error"));
    }
